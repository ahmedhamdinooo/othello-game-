...
# deepcopy is a technique of creating copies of a python object
from tkinter import *
from math import *
from time import *
from random import *
...
class Board:
    ...
    # Updating the board to the screen  ***********GUI CODE**************
    def update(self):
    ...
    # move based on a simple heuristic
...
def create_buttons():
    ...
    # Arrow
    screen.create_arc(5, 5, 45, 45, fill="#000088", width="2", style="arc", outline="black", extent=300)
    screen.create_polygon(33, 38, 36, 45, 40, 39, fill="white", outline="white")

    # Quit button
    # Background/shadow
    screen.create_rectangle(450, 5, 500, 55, fill="#FFFF00", outline="#000088")
    screen.create_rectangle(450, 0, 500, 50, fill="#FFFF00", outline="#000088")
    # "X"
    screen.create_line(455, 5, 495, 45, fill="red", width="3")
    screen.create_line(495, 5, 455, 40, fill="red", width="3")
...
def runGame():
    ...
    for i in range(1):
        ...
        screen.create_rectangle(100 + 100 * i, 300, 400 + 155 * i, 355, fill="#000", outline="#000")
        screen.create_rectangle(100 + 100 * i, 300, 400 + 155 * i, 350, fill="#111", outline="#111")

        spacing = 300 / (i + 2)
        for x in range(i + 1):
            # Star with double shadow
            screen.create_text(130 + (x + 1) * spacing + 90 * i, 326, anchor="c", text="start", font=("Consolas", 40),
                               fill="#b29600")
            screen.create_text(25 + (x + 1) * spacing + 155 * i, 326, anchor="c", text="\u2605", font=("Consolas", 40),
                               fill="#b29600")
            screen.create_text(25 + (x + 1) * spacing + 155 * i, 327, anchor="c", text="\u2605", font=("Consolas", 30),
                               fill="#b29600")
